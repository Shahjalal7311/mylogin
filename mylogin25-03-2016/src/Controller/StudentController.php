...
class StudentController extends AppController
{
    ...
    public function index()
    {
        $this->paginate = ['fields'=>
           ['id','fname','lname','email','phone','father_name','mother_name','address',
               ...
               'year'=> '(select year from batch where batch.id=Student.batch_id)'
               ],
            'limit' => 25,];
    ...
    public function view($id = null)
    {
        $student = $this->Student->find('all')
                ->select(['id','fname','lname','email','phone','father_name','mother_name','address',
                    'subjectname'=> '(select subject_name from subject where subject.id=Student.subject_id)',
                    'batchname'=> '(select bname from batch where batch.id=Student.batch_id)',
                    'year'=> '(select year from batch where batch.id=Student.batch_id)'
                    ])
